...
export const CONFLICT_ZONES: ConflictZone[] = [
  ...
  },
  {
    ...
    coords: [
      [72.50, 35.70], [69.40, 31.69], [65.95, 29.33],
      [64.90, 30.29], [71.02, 36.55], [72.50, 35.70],
    ],
    center: [69, 31.8],
    intensity: 'medium',
    ...
    description: 'Escalating tensions along the Pakistan–Afghanistan border. Pakistan has conducted cross-border strikes targeting TTP sanctuaries in Afghan territory. Border crossings at Torkham and Chaman have faced repeated closures. TTP continues attacks inside KPK province.',
