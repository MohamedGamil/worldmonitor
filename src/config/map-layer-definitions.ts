...
export const LAYER_REGISTRY: Record<keyof MapLayers, LayerDefinition> = {
  ...
  flights: def('flights', 'plane-civilian', 'flightDelays', 'Flight Delays'),
  ...
  ciiChoropleth: def('ciiChoropleth', 'globe', 'ciiChoropleth', 'CII Instability', ['flat']),
