...
export type IconName =
  ...
  | 'sun' | 'heart' | 'leaf' | 'siren' | 'notification' | 'flash-circle'
  | 'airport';
...
export function svgIcon(name: IconName, color: string, size = 12, extra = ''): string {
  ...
  switch (name) {
    ...
    case 'plane-civilian':
      ...
      return `<svg xmlns="http://www.w3.org/2000/svg" width="${s}" height="${s}" viewBox="-225.072 101.737 500 500" style="${shadow}" ${extra}>
        <path fill="${c}" fill-rule="evenodd" clip-rule="evenodd" transform="matrix(.707107 .707107 -.707107 .707107 8e-6 -4e-6)" d="M110.4 378.152C110.429 366.497 117.052 355.102 127.84 342.348L65.457 302.9C61.523 301.193 61.61 298.793 63.895 295.959L77.112 284.679C79.512 283.204 82.057 282.568 84.805 283.32L161.793 296.335 225.94 226.866 76.186 125.555C72.398 123.328 72.08 120.812 75.984 117.891L97.588 100.654 292.806 155.517 350.475 93.857C369.823 77.112 388.622 69.622 403.053 73.179 411.007 75.145 413.812 77.517 416.27 84.979 421.042 99.613 413.639 119.279 396.141 139.524L334.481 197.193 389.345 392.411 372.108 414.015C369.187 417.89 366.671 417.572 364.444 413.812L263.104 264.087 193.635 328.206 206.65 405.194C207.402 407.912 206.794 410.457 205.291 412.887L194.011 426.104C191.206 428.389 188.777 428.475 187.07 424.542L147.622 362.159C134.81 372.976 123.415 379.599 111.702 379.599 110.632 379.57 110.4 379.194 110.4 378.152Z"/>
      </svg>`;
    ...
    case 'flash-circle':
      return `<svg xmlns="http://www.w3.org/2000/svg" width="${s}" height="${s}" viewBox="0 0 24 24" style="${shadow}" ${extra}>
        <path fill="${c}" d="M12 2C6.48 2 2 6.48 2 12C2 17.52 6.48 22 12 22C17.52 22 22 17.52 22 12C22 6.48 17.52 2 12 2ZM15.53 13.23L10.35 16.82C9.59 17.35 9.15 17.04 9.37 16.15L10.32 12.31L8.67 11.9C7.92 11.72 7.83 11.2 8.46 10.76L13.64 7.17C14.4 6.64 14.84 6.95 14.62 7.84L13.67 11.68L15.32 12.09C16.07 12.28 16.16 12.79 15.53 13.23Z"/>
      </svg>`;

    case 'notification':
      return `<svg xmlns="http://www.w3.org/2000/svg" width="${s}" height="${s}" viewBox="0 0 24 24" style="${shadow}" ${extra}>
        <path fill="${c}" d="M19 8C20.6569 8 22 6.65685 22 5C22 3.34315 20.6569 2 19 2C17.3431 2 16 3.34315 16 5C16 6.65685 17.3431 8 19 8Z"/>
    ...
    case 'siren':
      return `<svg xmlns="http://www.w3.org/2000/svg" width="${s}" height="${s}" viewBox="0 0 24 24" style="${shadow}" ${extra}>
        <path fill="${c}" d="M12.75 2C12.75 1.58579 12.4142 1.25 12 1.25C11.5858 1.25 11.25 1.58579 11.25 2V5C11.25 5.41421 11.5858 5.75 12 5.75C12.4142 5.75 12.75 5.41421 12.75 5V2Z"/>
        <path fill="${c}" fill-rule="evenodd" clip-rule="evenodd" d="M2 21.25H4V16C4 11.5817 7.58172 8 12 8C16.4183 8 20 11.5817 20 16V21.25H22C22.4142 21.25 22.75 21.5858 22.75 22C22.75 22.4142 22.4142 22.75 22 22.75H2C1.58579 22.75 1.25 22.4142 1.25 22C1.25 21.5858 1.58579 21.25 2 21.25ZM12.75 18.7993C13.1984 18.54 13.5 18.0552 13.5 17.5C13.5 16.6716 12.8284 16 12 16C11.1716 16 10.5 16.6716 10.5 17.5C10.5 18.0552 10.8016 18.54 11.25 18.7993V21.25H12.75V18.7993ZM13.5953 11.2186C13.7507 10.8346 14.188 10.6494 14.5719 10.8048C15.7629 11.2869 16.7129 12.2369 17.195 13.4278C17.3504 13.8118 17.1651 14.249 16.7812 14.4044C16.3972 14.5599 15.96 14.3746 15.8046 13.9907C15.4749 13.1762 14.8235 12.5249 14.0091 12.1952C13.6252 12.0398 13.4399 11.6025 13.5953 11.2186Z"/>
        <path fill="${c}" d="M21.5303 5.46967C21.8232 5.76256 21.8232 6.23744 21.5303 6.53033L20.0303 8.03033C19.7374 8.32322 19.2626 8.32322 18.9697 8.03033C18.6768 7.73744 18.6768 7.26256 18.9697 6.96967L20.4697 5.46967C20.7626 5.17678 21.2374 5.17678 21.5303 5.46967Z"/>
        <path fill="${c}" d="M3.53033 5.46967C3.23744 5.17678 2.76256 5.17678 2.46967 5.46967C2.17678 5.76256 2.17678 6.23744 2.46967 6.53033L3.96967 8.03033C4.26256 8.32322 4.73744 8.32322 5.03033 8.03033C5.32322 7.73744 5.32322 7.26256 5.03033 6.96967L3.53033 5.46967Z"/>
      </svg>`;

    case 'airport':
      // Airport check-in: location pin with inner circle + aircraft silhouette (from airport-check-in.svg, optimized)
      return `<svg xmlns="http://www.w3.org/2000/svg" width="${s}" height="${s}" viewBox="0 0 512 512" style="${shadow}" ${extra}>
        <path fill="${c}" d="M132.6 287.7l118.3 175.2c2.4 3.6 7.8 3.6 10.2 0l118.3-175.2 6.1-9-.1.1c15.3-24.7 23.8-54 22.7-85.4-2.7-78.4-65.6-142.6-144-146.7C176.5 42.2 104 112.2 104 198.6c0 29.4 8.4 56.8 22.8 80.1 1.5 2.4 3.3 5.2 5.8 9zm123.4-196.7c59.4 0 107.6 48.2 107.6 107.6 0 59.4-48.2 107.6-107.6 107.6S148.4 258 148.4 198.6 196.6 91 256 91z"/>
        <path fill="${c}" d="M187.5 162.6c.6 1 1.4 1.8 2.3 2.4l36.1 26 10.3 61.3c.4 2.4 1.7 4.7 3.5 6.3l6.4 5.6c1.7 1.5 4.4.3 4.4-2l.4-53 35.9 26c8.2 5.9 19.2 6.2 27.7.7l13.8-9c1.6-1 1.9-3.2.6-4.6l-1.5-1.7c-2.8-3.1-7-4.6-11.2-3.8l-15.8 3-73.4-62.3c-7.1-6.1-16.2-9.6-25.6-9.5-3 .1-6.1.4-9.2 1.4-5.6 1.7-8 8-5 13.1l.3.4z"/>
        <path fill="${c}" d="M272.8 181.5c2.2 2 5.1 3 8 2.9l38.5-1.8c1.9-.4 2.4-2.8.9-4l-5.7-4.2c-1.7-1.2-3.7-1.9-5.7-1.8l-46.4-5.1c-1.9-.2-2.9 2.1-1.5 3.4z"/>
      </svg>`;
