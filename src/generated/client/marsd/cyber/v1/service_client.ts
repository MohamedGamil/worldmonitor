...
export class CyberServiceClient {
  ...
  async listCyberThreats(req: ListCyberThreatsRequest, options?: CyberServiceCallOptions): Promise<ListCyberThreatsResponse> {
    ...
    if (req.type != null && req.type !== "" && !req.type.endsWith("_UNSPECIFIED")) params.set("type", String(req.type));
    if (req.source != null && req.source !== "" && !req.source.endsWith("_UNSPECIFIED")) params.set("source", String(req.source));
    if (req.minSeverity != null && req.minSeverity !== "" && !req.minSeverity.endsWith("_UNSPECIFIED")) params.set("min_severity", String(req.minSeverity));
